...
export default function BecomeGuidePage() {
  ...
  const applyGuideMutation = useMutation({
    mutationFn: (data: typeof formData) => api.post('/guide-applications', data),
    onSuccess: () => {
      setSubmitted(true)
    },
    onError: () => {
      toast.error('Ошибка отправки заявки', 'Попробуйте ещё раз или напишите нам в Telegram')
    }
  })

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    applyGuideMutation.mutate(formData)
  }
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto mb-10">
              In Turex Pro — это не просто площадка. Это полноценная система управления 
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="mb-20">
          ...
          <div className="md:hidden max-w-full mx-auto mb-8">
            <img 
              src="/png.png" 
              alt="Личный кабинет гида" 
              className="w-full h-auto rounded-lg shadow-lg"
              loading="lazy"
            />
          </div>

          {/* Mockup Dashboard - скрыт на мобильных, показывается на десктопе */}
          <Card className="hidden md:block max-w-6xl mx-auto border-4 border-airbnb-rausch shadow-airbnb-lg overflow-hidden">
                ...
                <div className="grid grid-cols-3 gap-4 mb-6">
                  <Card className="border-green-200">
                    <CardContent className="pt-6">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-base text-gray-600">Активных экскурсий</p>
                  ...
                  <Card className="border-blue-200">
                    <CardContent className="pt-6">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-base text-gray-600">Заказов за месяц</p>
                  ...
                  <Card className="border-tropical-ocean">
                    <CardContent className="pt-6">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-base text-gray-600">Доход</p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="relative overflow-hidden">
              ...
              <CardContent>
                ...
                <div className="bg-gray-50 p-3 rounded-lg text-base text-gray-600">
          ...
          <Card id="application-form" className="max-w-3xl mx-auto mb-16 scroll-mt-24 overflow-hidden">
            ...
            <CardContent className="px-4 sm:px-6">
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                <Button type="submit" variant="tropical" className="w-full text-base sm:text-lg py-4 sm:py-6 gap-2" disabled={applyGuideMutation.isPending}>
                  <Send size={18} className="sm:w-5 sm:h-5" />
                  {applyGuideMutation.isPending ? 'Отправляем...' : 'Отправить заявку'}
                </Button>
          ...
          <Card className="max-w-2xl mx-auto mb-16 bg-green-50 border-2 border-green-200">
            <CardContent className="py-12 text-center">
              ...
              <p className="text-lg text-gray-700 mb-6">
                Спасибо за ваш интерес к работе гидом в In Turex Pro! Наш менеджер свяжется с вами 
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="bg-blue-50">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-700 text-base">
                  "Работаю с In Turex Pro уже полгода. Платформа удобная, клиенты платят вовремя, 
                  выплаты приходят быстро. Особенно нравится система QR-кодов — клиенты просто 
                  сканируют и оплачивают."
                </p>
                <p className="text-sm text-gray-500 mt-3">Гид в Пхукете • 3 года опыта</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-green-50 to-white">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-700 text-base">
                  "До In Turex Pro тратил кучу времени на прием платежей и бухгалтерию. Теперь все 
                  автоматизировано — я только провожу экскурсии и получаю деньги. Доход вырос на 40%!"
                </p>
                <p className="text-sm text-gray-500 mt-3">Гид в Бангкоке • 5 лет опыта</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-purple-50">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-gray-500 mt-3">Гид в Паттайе • 2 года опыта</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="text-center bg-airbnb-rausch text-white rounded-3xl p-12 max-w-5xl mx-auto">
          ...
          <p className="text-base mt-6 opacity-75">
