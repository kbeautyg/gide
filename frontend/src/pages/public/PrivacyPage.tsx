        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-gray-700">
              <p>
                ОсОО «Интурекс» (далее — «мы», «Компания») уважает вашу конфиденциальность и стремится
                ...
                веб-сайта inturex.pro (далее — «Сайт») и наших услуг.
              </p>
              <p>
          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-gray-700">
              ...
              <ol className="list-decimal pl-6 space-y-2">
                ...
                <li>Или отправьте запрос на email: help@inturex.pro</li>
