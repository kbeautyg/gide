      ...
      <div className="py-12">
        <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li>🇹🇭 10:00 — 19:00 <span className="text-gray-500">(GMT+7)</span></li>
              <li>🇰🇬 9:00 — 19:00 <span className="text-gray-500">(GMT+6)</span></li>
              <li>🇷🇺 9:00 — 19:00 <span className="text-gray-500">(МСК)</span></li>
              <li className="pt-1 text-white/60">📧 Поддержка 24/7</li>
            </ul>
          </div>
        </div>
