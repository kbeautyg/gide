      ...
      {visible && !dismissed && (
        ...
        >
          <div className="relative">
            ...
            <button
              onClick={handleClose}
              className="absolute -top-2 -right-2 w-6 h-6 bg-gray-900 text-white rounded-full flex items-center justify-center hover:bg-gray-800 transition-colors z-10 shadow-md"
            >
              <X size={14} />
            </button>
            ...
            <Link to="/request">
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-airbnb-rausch text-white px-6 py-4 rounded-full shadow-2xl flex items-center gap-3 hover:bg-airbnb-rausch/90 transition-colors"
              >
                <Sparkles size={24} />
