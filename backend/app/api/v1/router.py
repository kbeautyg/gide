...
from app.api.v1.endpoints import auth, users, tours, bookings, admin, requests, user_profile, transactions
...
api_router.include_router(transactions.router, prefix="/transactions", tags=["Транзакции"])
