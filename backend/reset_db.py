...
async def reset_db():
    ...
    async with engine.begin() as conn:
        ...
        await conn.execute(sa.text("DROP TABLE IF EXISTS guide_schedules CASCADE"))
        await conn.execute(sa.text("DROP TABLE IF EXISTS reviews CASCADE"))
        await conn.execute(sa.text("DROP TABLE IF EXISTS landmarks CASCADE"))
        await conn.execute(sa.text("DROP TABLE IF EXISTS destinations CASCADE"))
        await conn.execute(sa.text("DROP TABLE IF EXISTS articles CASCADE"))
