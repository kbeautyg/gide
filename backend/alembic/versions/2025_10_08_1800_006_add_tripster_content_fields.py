...
revision = '2025_10_08_1800_006_add_tripster_content_fields'
down_revision = '2025_10_08_1500_005_add_tour_is_public'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_index('ix_articles_country_tag', 'articles', ['country_tag'])
